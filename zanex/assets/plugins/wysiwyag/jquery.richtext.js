    ...
    $.fn.richText = function( options ) {
        ...
        var settings = $.extend({
            ...
            translations: {
                ...
                'addOrderedList': 'Sıralı Liste Ekle',
                'addUnorderedList': 'Sırasız Liste Ekle',
                'addHeading': 'Başlık/Başlık Ekle',
                'addFont': 'Font Ekle',
                'addFontColor': 'Yazı Tipi Rengi Ekle',
                'addFontSize': 'Yazı Tipi Boyutu Ekle',
                'addImage': 'Add image',
                'addVideo': 'Add video',
                'addFile': 'Add file',
                'addURL': 'Add URL',
                'addTable': 'Add table',
                'removeStyles': 'Sıfırla',
                'code': 'Show HTML code',
                'undo': 'Geri Alma',
                'redo': 'İleri Alma',
                'close': 'Kapat'
