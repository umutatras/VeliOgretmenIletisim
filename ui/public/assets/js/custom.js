(function($) {
	...
	$(document).ready(function () {
		...
		if (bodyhorizontal) {
			...
			let horizElement = document.querySelector('.horizontal');
			if (horizElement && horizElement.firstElementChild && horizElement.firstElementChild.classList.contains('login-img') !== true) {
				let sideMenu = document.querySelector('.horizontal .side-menu');
				if(sideMenu) sideMenu.style.flexWrap = 'nowrap';
				checkHoriMenu();
				responsive();
			}
		} else {
	...
	$(document).ready(function () {
		...
		if (bodyhorizontal) {
			...
			$('#slide-left').removeClass('d-none');
			$('#slide-right').removeClass('d-none');
			let horizHoverElement = document.querySelector('.horizontal-hover');
			if (horizHoverElement && horizHoverElement.firstElementChild && horizHoverElement.firstElementChild.classList.contains('login-img') !== true) {
				let sideMenuHover = document.querySelector('.horizontal-hover .side-menu');
				if(sideMenuHover) sideMenuHover.style.flexWrap = 'nowrap';
				checkHoriMenu();
				responsive();
			}
		} else {
