        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ComplaintRequests_Parents_ParentId",
                        column: x => x.ParentId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MeetingNotes_Parents_ParentId",
                        column: x => x.ParentId,
                        principalTable: "Parents",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MeetingNotes_Teachers_TeacherId",
                        column: x => x.TeacherId,
                        principalTable: "Teachers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ComplaintRequests_ParentId",
                table: "ComplaintRequests",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_MeetingNotes_ParentId",
                table: "MeetingNotes",
                column: "ParentId");

            migrationBuilder.CreateIndex(
                name: "IX_MeetingNotes_TeacherId",
                table: "MeetingNotes",
                column: "TeacherId");
